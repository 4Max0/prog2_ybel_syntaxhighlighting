...
public final class MiniJavaColours {
  ...
  public static final Color NUMBER_COLOUR = new Color(35, 85, 235);
  public static final Color IDENTIFIER_COLOUR = new Color(191, 124, 30);
  public static final Color TYPE_NAME_COLOUR = new Color(163, 202, 61);
  public static final Color OPERATOR_COLOUR = new Color(83, 31, 143);
  public static final Color BOOLEAN_LITERAL_COLOUR = new Color(191, 15, 15);
}
